...
public class Application extends Controller {
	...
	public static void createPowerTagCable(String poiId,
			String powerTags_Cable_cables, String powerTags_Cable_circuits,
			String powerTags_Cable_location, String powerTags_Cable_name,
			String types_Operator_name, String types_Operator_type,
			String powerTags_Cable_ref, String powerTags_Cable_voltage) {
		...
		if (powerTags_Cable_location.equals("")) {
			...
			cable.location = Cable.LocationEnum
					.valueOf(powerTags_Cable_location);
		}
		...
		if (types_Operator_type.equals("")) {
			...
			cable.operator.type = Operator.TypeEnum
					.valueOf(types_Operator_type);
		}
	...
	public static void createPowerTagCableDistributionCabinet(String poiId,
			String types_Operator_name, String types_Operator_type,
			String powerTags_CableDistributionCabinet_ref,
		...
		if (types_Operator_type.equals("")) {
			...
			cableDistributionCabinet.operator.type = Operator.TypeEnum
					.valueOf(types_Operator_type);
		}
		...
		if (powerTags_CableDistributionCabinet_voltage.equals("")) {
			...
			cableDistributionCabinet.voltage = Float
					.parseFloat(powerTags_CableDistributionCabinet_voltage);
		}
		poi.powerTag.save();
	}

	public static void createPowerTagConverter(String poiId,
			String powerTags_Converter_converter,
			String powerTags_Converter_poles,
			String powerTags_Converter_rating,
		...
		if (powerTags_Converter_converter.equals("")) {
			...
			converterObject.converter = Converter.ConverterEnum
					.valueOf(powerTags_Converter_converter);
		}
		...
		if (powerTags_Converter_voltage.equals("")) {
			...
			converterObject.voltage = Float
					.parseFloat(powerTags_Converter_voltage);
		}
		poi.powerTag.save();
	}

	public static void createPowerTagGenerator(String poiId,
			String powerTags_Generator_name, String types_Operator_name,
			String types_Operator_type, String powerTags_Generator_output,
			String powerTags_Generator_plant,
			String powerTags_Generator_source,
			String powerTags_Generator_method, String powerTags_Generator_type) {
		Poi poi = Poi.findById(Long.parseLong(poiId));
		...
		if (types_Operator_type.equals("")) {
			...
			generator.operator.type = Operator.TypeEnum
					.valueOf(types_Operator_type);
		}
		...
		if (powerTags_Generator_output.equals("")) {
			...
			generator.output = Generator.OutputEnum
					.valueOf(powerTags_Generator_output);
		}

		if (powerTags_Generator_plant.equals("")) {
			generator.plant = null;
		} else {
			generator.plant = Generator.PlantEnum
					.valueOf(powerTags_Generator_plant);
		}

		if (powerTags_Generator_source.equals("")) {
			generator.source = null;
		} else {
			generator.source = Generator.SourceEnum
					.valueOf(powerTags_Generator_source);
		}

		if (powerTags_Generator_method.equals("")) {
			generator.method = Generator.MethodEnum.NULL;
		} else {
			generator.setMethodEnum(Generator.MethodEnum
					.valueOf(powerTags_Generator_method));
		}

		if (powerTags_Generator_type.equals("")) {
			generator.type = Generator.TypeEnum.NULL;
		} else {
			generator.setTypeEnum(Generator.TypeEnum
					.valueOf(powerTags_Generator_type));
		}
		poi.powerTag.save();
	}

	public static void createPowerTagLine(String poiId,
			String powerTags_Line_cables, String types_Operator_name,
			String types_Operator_type, String powerTags_Line_ref,
			String powerTags_Line_voltage, String powerTags_Line_wires) {
		Poi poi = Poi.findById(Long.parseLong(poiId));
	...
	public static void createPowerTagMinorLine(String poiId,
			String powerTags_MinorLine_cables, String powerTags_MinorLine_name,
			String types_Operator_name, String types_Operator_type,
		...
		if (types_Operator_type.equals("")) {
			...
			minorLine.operator.type = Operator.TypeEnum
					.valueOf(types_Operator_type);
		}
	...
	public static void createPowerTagPlant(String poiId,
			String powerTags_Plant_landuse, String powerTags_Plant_name,
			String types_Operator_name, String types_Operator_type,
			String powerTags_Plant_output, String powerTags_Plant_start_date)
		...
		if (types_Operator_type.equals("")) {
			...
			plant.operator.type = Operator.TypeEnum
					.valueOf(types_Operator_type);
		}
		...
		if (powerTags_Plant_start_date.equals("")) {
			...
			plant.start_date = new SimpleDateFormat("yyyy/MM/dd HH:mm:ss")
					.parse(powerTags_Plant_start_date).getTime();
		}
		poi.powerTag.save();
	}

	public static void createPowerTagPole(String poiId,
			String powerTags_Pole_ref) {
		Poi poi = Poi.findById(Long.parseLong(poiId));
	...
	public static void createPowerTagSubstation(String poiId,
			String powerTags_Substation_gas_insulated,
			String powerTags_Substation_location,
			String powerTags_Substation_name, String types_Operator_name,
			String types_Operator_type, String powerTags_Substation_ref,
			String powerTags_Substation_substationType,
			String powerTags_Substation_voltage) {
		Poi poi = Poi.findById(Long.parseLong(poiId));
		...
		if (powerTags_Substation_gas_insulated.equals("")) {
			...
			substation.gas_insulated = Boolean
					.valueOf(powerTags_Substation_gas_insulated);
		}
		...
		if (powerTags_Substation_location.equals("")) {
			...
			substation.location = Substation.LocationEnum
					.valueOf(powerTags_Substation_location);
		}
		...
		if (types_Operator_type.equals("")) {
			...
			substation.operator.type = Operator.TypeEnum
					.valueOf(types_Operator_type);
		}
		...
		if (powerTags_Substation_substationType.equals("")) {
			...
			substation.substationType = Substation.SubstationTypeEnum
					.valueOf(powerTags_Substation_substationType);
		}
	...
	public static void createPowerTagTower(String poiId,
			String powerTags_Tower_color, String powerTags_Tower_design,
			String powerTags_Tower_height, String powerTags_Tower_material,
			String powerTags_Tower_ref, String powerTags_Tower_structure,
			String powerTags_Tower_type) {
		Poi poi = Poi.findById(Long.parseLong(poiId));
		...
		if (matcher.matches()) {
			tower.color = new Color(Integer.valueOf(matcher.group(1)),
					Integer.valueOf(matcher.group(2)), Integer.valueOf(matcher
							.group(3)));
		} else {
			tower.color = null;
		}
		...
		if (powerTags_Tower_material.equals("")) {
			...
			tower.material = Tower.MaterialEnum
					.valueOf(powerTags_Tower_material);
		}
		...
		if (powerTags_Tower_structure.equals("")) {
			...
			tower.structure = Tower.StructureEnum
					.valueOf(powerTags_Tower_structure);
		}
	...
	public static void createPowerTagTransformer(String poiId,
			String powerTags_Transformer_frequency,
			String powerTags_Transformer_location,
			String powerTags_Transformer_phases,
			String powerTags_Transformer_rating,
			String powerTags_Transformer_transformerType,
			String powerTags_Transformer_voltage) {
		Poi poi = Poi.findById(Long.parseLong(poiId));
		...
		if (powerTags_Transformer_frequency.equals("")) {
			...
			transformer.frequency = Float
					.parseFloat(powerTags_Transformer_frequency);
		}
		...
		if (powerTags_Transformer_location.equals("")) {
			...
			transformer.location = Transformer.LocationEnum
					.valueOf(powerTags_Transformer_location);
		}
		...
		if (powerTags_Transformer_transformerType.equals("")) {
			...
			transformer.transformerType = Transformer.TransformerEnum
					.valueOf(powerTags_Transformer_transformerType);
		}

		if (powerTags_Transformer_voltage.equals("")) {
			transformer.voltage = null;
		} else {
			transformer.voltage = Float
					.parseFloat(powerTags_Transformer_voltage);
		}
		poi.powerTag.save();
	}
	...
	public static String getColor(String poiId) {
		...
		if (poi.powerTag != null && poi.powerTag.getClass() == Tower.class
				&& ((Tower) poi.powerTag).color != null) {
			String hexColor = Integer.toHexString(((Tower) poi.powerTag).color
					.getRGB());
	...
	private static String getHtmlCode(Field[] objectFields,
			Object objectWithValues, String source, String method)
		...
		for (Field field : objectFields) {
			...
			String fieldId = fieldDeclaringClass.replace("models.", "")
					.replace(".", "_") + "_" + fieldName;
			String fieldLabel = fieldName.replace("_", " ").replace("T", " t");
			String fieldAbsoluteName = fieldDeclaringClass + "." + fieldName;

			StringBuffer select = new StringBuffer();
			select.append("   <label for='" + fieldId + "'>" + fieldLabel
					+ "</label>" + newLine);
			select.append("   <select name='" + fieldId + "' id='" + fieldId
					+ "' class='submitPoiDataField'>" + newLine);
			select.append("      <option value=''> </option>" + newLine);

			if (fieldName.equals("id")
					|| fieldName.equals("willBeSaved")
					|| fieldAbsoluteName.equals("models.Poi.powerTag")
					|| fieldAbsoluteName
							.equals("models.types.Operator.powerTag")
			...
			if (fieldAbsoluteName.equals("models.Poi.photos")) {
				...
				for (int i = 0; i < list.size(); i++) {
					output.append("<img width='200' src='/application/getpicture?position="
							+ i
							+ "&id="
							+ poiId
							+ "' alt='image of poi with id "
							+ poiId
							+ " on position " + i + "'/>" + newLine);
				}
			} else if (fieldType
					.equals("models.powerTags.Generator$MethodEnum")
					|| fieldType.equals("models.powerTags.Generator$TypeEnum")) {
				if (objectFields.length == 1) {
					Object[] enums;

					if (fieldType
							.equals("models.powerTags.Generator$MethodEnum")) {
						enums = Generator.getMethods(Generator.SourceEnum
								.valueOf(source));
					} else {
						enums = Generator.getTypes(
								Generator.SourceEnum.valueOf(source),
								Generator.MethodEnum.valueOf(method));
					}

					if (enums.length >= 1) {
						Method getName = enums[0].getClass().getMethod(
								"getName");
						...
						if (enums.length > 1) {
							...
							for (int i = 0; i < enums.length; i++) {
								enumArrayFieldName = (String) getName
										.invoke(enums[i]);
								enumArrayFieldType = (String) getType
										.invoke(enums[i]);
								String selected = "";

								if (objectWithValues != null
										&& field.get(objectWithValues) != null
										&& field.get(objectWithValues)
												.toString()
												.equals(enumArrayFieldType)) {
									if (((Generator) objectWithValues).source
											.name().equals(source)
											&& fieldType
													.equals("models.powerTags.Generator$MethodEnum")) {
										selected = "selected=''";
									} else if (((Generator) objectWithValues).source
											.name().equals(source)
											&& ((Generator) objectWithValues).method
													.name().equals(method)
											&& fieldType
													.equals("models.powerTags.Generator$TypeEnum")) {
										selected = "selected=''";
									}
								}
								output.append("      <option " + selected
										+ " value='" + enumArrayFieldType
										+ "'>" + enumArrayFieldName
										+ "</option>" + newLine);
							}
							output.append("</select>" + newLine);
							...
							output.append("   <span>" + fieldLabel + ":</span>"
									+ newLine);
							output.append("   <span id='" + fieldId
									+ "' style='display:none;'>"
									+ enumArrayFieldType + "</span>" + newLine);
							output.append("   <span                                           >"
									+ enumArrayFieldName + "</span>" + newLine);
							output.append("</p>");
						}
					}
				}
				...
				for (Object enumConstant : enumClass.getEnumConstants()) {
					...
					if (objectWithValues != null
							&& field.get(objectWithValues) != null
							&& field.get(objectWithValues).equals(enumConstant)) {
						selected = "selected=''";
					}

					output.append("      <option value='" + enumType + "' "
							+ selected + ">" + enumName + "</option>" + newLine);
				}
				output.append("</select>" + newLine);
				...
				if (fieldType.equals("models.powerTags.Generator$SourceEnum")) {
					...
					if (objectWithValues != null
							&& ((Generator) objectWithValues).source != null) {
						String poiId = ((Generator) objectWithValues).poi.id
								.toString();
						String sourceName = ((Generator) objectWithValues).source
								.name();
						htmlMethods = getHtmlMethods(sourceName, poiId);

						if (((Generator) objectWithValues).method != null) {
							String methodName = ((Generator) objectWithValues).method
									.name();
							htmlTypes = getHtmlTypes(sourceName, methodName,
									poiId);
						}
					}

					output.append("<div id='generatorMethod'>" + htmlMethods
							+ "</div>" + newLine);
					output.append("<div id='generatorType'>" + htmlTypes
							+ "</div>" + newLine);
				}
				...
				output.append(getHtmlCode(Operator.class.getFields(), operator,
						source, method) + newLine);
				...
				if (objectWithValues != null
						&& field.get(objectWithValues) != null) {
					String hexColor = Integer.toHexString(((Color) field
							.get(objectWithValues)).getRGB());
				...
				output.append("   <span class='color-box submitPoiDataField' id='"
						+ fieldId
				...
				if (objectWithValues != null
					...
					fieldValue = dateFormat.format(
							new Date(Long.parseLong(field.get(objectWithValues)
									.toString()))).toString();
				}
				output.append("<p>" + newLine);
				output.append("   <label for='" + fieldId + "'>" + fieldLabel
						+ "</label>" + newLine);
				output.append("   <input class='datetimepicker submitPoiDataField' id='"
						+ fieldId
						+ "' name='"
						+ fieldId
						+ "' type='text' value='"
				...
				if (objectWithValues != null
					...
					if (fieldValue) {
						output.append("      <option value='false'>false</option>"
								+ newLine);
						output.append("      <option selected='' value='true'>true</option>"
								+ newLine);
					} else {
						output.append("      <option selected='' value='false'>false</option>"
								+ newLine);
						output.append("      <option value='true'>true</option>"
								+ newLine);
					}
				} else {
					output.append("      <option value='false'>false</option>"
				...
				output.append("</select>" + newLine);
					...
					|| fieldType.equals("java.lang.Long")
					|| (fieldType.equals("java.lang.String") && fieldName
							.equals("cables"))) {
				...
				output.append("   <label for='" + fieldId + "'>" + fieldLabel
						+ "</label>" + newLine);
				output.append("   <input class='" + additionalClass
						+ " submitPoiDataField' id='" + fieldId + "' name='"
						+ fieldId + "' " + step + " type='" + type
						+ "' value='" + fieldValue + "'/>" + newLine);
				output.append("</p>" + newLine);
			} else {
				String fieldValue = "";
				...
				output.append("   <label for='" + fieldId + "'>" + fieldLabel
						+ "</label>" + newLine);
				output.append("   <input class='submitPoiDataField' id='"
	...
	public static String getHtmlMethods(String source, String poiId)
			throws IllegalArgumentException, IllegalAccessException,
	...
	public static String getHtmlPoi(String poiId)
			throws IllegalArgumentException, IllegalAccessException,
			ClassNotFoundException, NoSuchMethodException, SecurityException,
			InvocationTargetException, NoSuchFieldException {
		Poi poi = Poi.findById(Long.valueOf(poiId));
	...
	public static String getHtmlPowerTagDetails(String powerTag, String poiId)
			throws IllegalArgumentException, IllegalAccessException,
			NoSuchFieldException, SecurityException, ClassNotFoundException,
			NoSuchMethodException, InvocationTargetException {
		Poi poi = Poi.findById(Long.valueOf(poiId));
		...
		Field[] objectFields = Class.forName("models.powerTags." + powerTag)
				.getFields();
		return getHtmlCode(objectFields, poiPowerTag, "", "");
	}

	public static String getHtmlTypes(String source, String method, String poiId)
			throws IllegalArgumentException, IllegalAccessException,
			NoSuchFieldException, SecurityException, ClassNotFoundException,
			NoSuchMethodException, InvocationTargetException {
		Poi poi = Poi.findById(Long.valueOf(poiId));
	...
	public static void updatePoi(String Poi_accuracy, String Poi_altitude,
			String Poi_bearing, String poiId, String Poi_latitude,
		...
		poi.time = new SimpleDateFormat("yyyy/MM/dd HH:mm:ss").parse(Poi_time)
				.getTime();
		poi.save();
		index();
	}
