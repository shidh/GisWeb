...
public class Generator extends PowerTag {
	...
	public static MethodEnum[] getMethods(SourceEnum source) {
		...
		case WIND:
			...
			break;
		case HYDRO:
			methods = new MethodEnum[] { MethodEnum.RUN_OF_THE_RIVER,
					MethodEnum.WATER_PUMPED_STORAGE, MethodEnum.WATER_STORAGE };
			break;
		case NUCLEAR:
			methods = new MethodEnum[] { MethodEnum.FISSION, MethodEnum.FUSION };
			break;
		case SOLAR:
			methods = new MethodEnum[] { MethodEnum.PHOTOVOLTAIC,
					MethodEnum.THERMAL };
			break;
		case TIDAL:
	...
	public static TypeEnum[] getTypes(SourceEnum source, MethodEnum method) {
		...
		case DIESEL:
		case GASOLINE:
			types = new TypeEnum[] { TypeEnum.RECIPROCATING_ENGINE,
					TypeEnum.STEAM_GENERATOR };
			break;
		case BIOGAS:
			types = new TypeEnum[] { TypeEnum.GAS_TURBINE,
					TypeEnum.RECIPROCATING_ENGINE, TypeEnum.STEAM_GENERATOR };
			break;
		case BIOMASS:
			if (method == MethodEnum.COMBUSTION) {
				types = new TypeEnum[] { TypeEnum.STEAM_GENERATOR,
						TypeEnum.STEAM_TURBINE };
		...
		case OIL:
			...
			break;
		case GAS:
			types = new TypeEnum[] { TypeEnum.COMBINED_CYCLE,
					TypeEnum.GAS_TURBINE, TypeEnum.RECIPROCATING_ENGINE,
					TypeEnum.STEAM_GENERATOR, TypeEnum.STEAM_TURBINE };
			break;
		case GEOTHERMAL:
			types = new TypeEnum[] { TypeEnum.HEAT_PUMP, TypeEnum.STEAM_TURBINE };
			break;
		case HYDRO:
			if (method == MethodEnum.RUN_OF_THE_RIVER
					|| method == MethodEnum.WATER_STORAGE) {
				types = new TypeEnum[] { TypeEnum.FRANCIS_TURBINE,
						TypeEnum.KAPLAN_TURBINE, TypeEnum.PELTON_TURBINE };
		...
		case NUCLEAR:
			if (method == MethodEnum.FISSION) {
				types = new TypeEnum[] { TypeEnum.BWR_1, TypeEnum.BWR_2,
						TypeEnum.BWR_3, TypeEnum.BWR_4, TypeEnum.BWR_5,
						TypeEnum.BWR_6, TypeEnum.CANDU, TypeEnum.CPR_1000,
						TypeEnum.EPR, TypeEnum.PWR, TypeEnum.RBMK_1000,
						TypeEnum.RBMK_1500, TypeEnum.VVER };
			} else if (method == MethodEnum.FUSION) {
				types = new TypeEnum[] { TypeEnum.COLD_FUSION, TypeEnum.ICF,
						TypeEnum.STELLARATOR, TypeEnum.TOKAMAK };
			}
			break;
		case SOLAR:
			if (method == MethodEnum.PHOTOVOLTAIC) {
				...
				types = new TypeEnum[] { TypeEnum.SOLAR_THERMAL_COLLECTOR,
						TypeEnum.STEAM_TURBINE };
			}
			break;
		case TIDAL:
			if (method == MethodEnum.BARRAGE) {
				...
				types = new TypeEnum[] { TypeEnum.HORIZONTAL_AXIS,
						TypeEnum.VERTICAL_AXIS };
			}
			break;
		case WASTE:
			if (method == MethodEnum.COMBUSTION) {
