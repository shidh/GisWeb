...
public class Generator extends PowerTag {
	...
	public enum MethodEnum {
		ANAEROBIC_DIGESTION("Anaerobic Digestion"), BARRAGE("Barrage"), COMBUSTION(
				...
				"Gasification"), NULL("null"), PHOTOVOLTAIC("Photovoltaic"), RUN_OF_THE_RIVER(
	...
	public enum PlantEnum {
		INTERMEDIATE("Intermediate"), NULL("null"), OUTPUT("Output");
	...
	public enum TypeEnum {
		BIOREACTOR("Bioreactor"), BWR_1("BWR-1"), BWR_2("BWR-2"), BWR_3("BWR-3"), BWR_4(
				"BWR-4"), BWR_5("BWR-5"), BWR_6("BWR-6"), CANDU("CANDU"), COLD_FUSION(
				...
				"Horizontal Axis"), HYDRODYNAMIC_SCREW("Hydrodynamic Screw"), ICF("ICF"), KAPLAN_TURBINE("Kaplan Turbine"), NULL(
